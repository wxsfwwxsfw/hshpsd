...
const map = [
    ...
    [
        ...
        { type: TILE_TYPE_ENUM.FLOOR, name: 'f_0_1' },
        { type: TILE_TYPE_ENUM.FLOOR, name: 'f_1_2' },  // y=2 草（桃A落x=2,y=3）
    ...
    [
        ...
        { type: TILE_TYPE_ENUM.FLOOR, name: 'f_0_1' },
        { type: TILE_TYPE_ENUM.FLOOR, name: 'f_1_2' },  // y=2 草（桃B落x=4,y=3）
...
// 桃A x=1,y=5（收→去x=2,y=4→投UP→落x=2,y=3遮蜘蛛A）
// 桃B x=4,y=4（收→去x=4,y=4→投UP→落x=4,y=3遮蜘蛛B）
const peaches = [
...
// A x=1,y=2 RIGHT；B x=5,y=3 LEFT；C x=5,y=2 DOWN（威胁x=5,y=3+；钥匙在y=1安全）
const spiders = [
...
// G1 x=3,y=2 → 开关1 x=1,y=4；G2 x=3,y=1 → 开关2 x=1,y=3
const floor_traps = [
    { type: ENTITY_TYPE_ENUM.FLOOR_TRAP, x: 3, y: 2, dir: ENTITY_DIRECTION_ENUM.DOWN, state: ENTITY_STATE_ENUM.ATTACK, entityId: 'l25_ft_1' },
    { type: ENTITY_TYPE_ENUM.FLOOR_TRAP, x: 3, y: 1, dir: ENTITY_DIRECTION_ENUM.DOWN, state: ENTITY_STATE_ENUM.ATTACK, entityId: 'l25_ft_2' },
]
const floor_trap_switches = [
    { type: ENTITY_TYPE_ENUM.FLOOR_TRAP_SWITCH, x: 1, y: 4, dir: ENTITY_DIRECTION_ENUM.DOWN, state: ENTITY_STATE_ENUM.IDLE, entityId: 'l25_ft_1' },
    { type: ENTITY_TYPE_ENUM.FLOOR_TRAP_SWITCH, x: 1, y: 3, dir: ENTITY_DIRECTION_ENUM.DOWN, state: ENTITY_STATE_ENUM.IDLE, entityId: 'l25_ft_2' },
]
...
export default { map, player, doors, key, peaches, spiders, floor_traps, floor_trap_switches, floor_spikes, grass }
