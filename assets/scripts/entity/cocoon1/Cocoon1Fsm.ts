...
export default class Cocoon1Fsm extends FiniteStateMachine {
    ...
    initStateMachines() {
        this.stateMachines.set(ENTITY_STATE_ENUM.IDLE, new FiniteState(this, { path: 'cocoon/cocoon_small', resourceType: RESOURCE_TYPE_ENUM.SPRITE_FRAME }))
    }
}
