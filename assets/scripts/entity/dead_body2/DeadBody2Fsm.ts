...
export default class DeadBody2Fsm extends FiniteStateMachine {
    ...
    initStateMachines() {
        this.stateMachines.set(ENTITY_STATE_ENUM.IDLE, new FiniteState(this, { path: 'dead_body/bone_pile_large', resourceType: RESOURCE_TYPE_ENUM.SPRITE_FRAME }))
    }
}
