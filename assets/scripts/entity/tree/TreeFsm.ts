...
export default class TreeFsm extends FiniteStateMachine {
    ...
    initStateMachines() {
        this.stateMachines.set(ENTITY_STATE_ENUM.IDLE, new FiniteState(this, { path: 'tree/spirit_tree', resourceType: RESOURCE_TYPE_ENUM.SPRITE_FRAME }))
    }
}
