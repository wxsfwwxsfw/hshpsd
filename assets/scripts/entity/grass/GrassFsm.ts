...
export default class SteleFsm extends FiniteStateMachine {
    ...
    initStateMachines() {
        this.stateMachines.set(ENTITY_STATE_ENUM.IDLE, new FiniteState(this, { path: 'grass/grass_patch', resourceType: RESOURCE_TYPE_ENUM.SPRITE_FRAME }))
    }
}
