...
export default class CobwebFsm extends FiniteStateMachine {
    ...
    initStateMachines() {
        this.stateMachines.set(ENTITY_STATE_ENUM.IDLE, new FiniteState(this, { path: 'cobweb/cobweb_sticky', resourceType: RESOURCE_TYPE_ENUM.SPRITE_FRAME }))
    }
}
