...
export default class DeadBody1Fsm extends FiniteStateMachine {
    ...
    initStateMachines() {
        this.stateMachines.set(ENTITY_STATE_ENUM.IDLE, new FiniteState(this, {
            path: 'dead_body/bone_pile_small', resourceType: RESOURCE_TYPE_ENUM.SPRITE_FRAME
        }))
    }
}
