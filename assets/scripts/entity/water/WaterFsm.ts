...
export default class WaterFsm extends FiniteStateMachine {
    ...
    initStateMachines(){
        this.stateMachines.set(ENTITY_STATE_ENUM.IDLE, new FiniteState(this, {path:'water/idle', mode: cc.WrapMode.Loop, speed: 0.2}))
    }
}
