...
export default class StoneFsm extends FiniteStateMachine {
    ...
    initStateMachines() {
        this.stateMachines.set(ENTITY_STATE_ENUM.IDLE, new FiniteState(this, { path: 'stone/stone_large', resourceType: RESOURCE_TYPE_ENUM.SPRITE_FRAME }))
    }
}
