...
export default class Cocoon2Fsm extends FiniteStateMachine {
    ...
    initStateMachines() {
        this.stateMachines.set(ENTITY_STATE_ENUM.IDLE, new FiniteState(this, { path: 'cocoon/cocoon_large', resourceType: RESOURCE_TYPE_ENUM.SPRITE_FRAME }))
    }
}
