...
export default class PigFsmForIdle extends FiniteStateMachineSub {
    ...
    constructor(fsm: FiniteStateMachine){
        super(fsm)
        this.stateMachines.set(ENTITY_DIRECTION_ENUM.UP, new FiniteState(fsm, {path: 'pig/idle/up', mode: cc.WrapMode.Loop}))
        this.stateMachines.set(ENTITY_DIRECTION_ENUM.DOWN, new FiniteState(fsm, {path: 'pig/idle/down', mode: cc.WrapMode.Loop}))
        this.stateMachines.set(ENTITY_DIRECTION_ENUM.LEFT, new FiniteState(fsm, {path: 'pig/idle/left', mode: cc.WrapMode.Loop}))
        this.stateMachines.set(ENTITY_DIRECTION_ENUM.RIGHT, new FiniteState(fsm, {path: 'pig/idle/right', mode: cc.WrapMode.Loop}))
    }
